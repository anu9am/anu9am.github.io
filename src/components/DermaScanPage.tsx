    ...
    <main className="min-h-dvh flex flex-col gap-8 relative">
            ...
            <BlurFade delay={BLUR_FADE_DELAY} className="order-1 md:order-2">
              <div className="size-24 md:size-32 border rounded-full shadow-lg ring-4 ring-muted flex items-center justify-center bg-white overflow-hidden">
                <img 
                  ...
                  src="/Photos/Projects/DermaScan/DP_DermaScan.png" 
      ...
      <section id="certificate">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-6 w-full">
          <BlurFade delay={BLUR_FADE_DELAY * 12} className="flex-1 w-full">
            <div className="w-full rounded-xl overflow-hidden border shadow-sm ring-2 ring-border bg-muted">
              <img 
                src="/Photos/Projects/DermaScan/MEDHA_Certificate1.png" 
                alt="MEDHA Certificate Page 1" 
                className="w-full h-auto object-contain" 
              />
            </div>
          </BlurFade>
          <BlurFade delay={BLUR_FADE_DELAY * 13} className="flex-1 w-full">
            <div className="w-full rounded-xl overflow-hidden border shadow-sm ring-2 ring-border bg-muted">
              <img 
                src="/Photos/Projects/DermaScan/MEDHA_Certificate2.png" 
                alt="MEDHA Certificate Page 2" 
                className="w-full h-auto object-contain" 
              />
            </div>
          </BlurFade>
